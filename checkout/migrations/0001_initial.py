    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_cost', models.DecimalField(decimal_places=0, default=0, max_digits=6)),
                ('order_total', models.DecimalField(decimal_places=0, default=0, max_digits=10)),
                ('grand_total', models.DecimalField(decimal_places=0, default=0, max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_components', models.CharField(blank=True, max_length=15, null=True)),
                ('quantity', models.IntegerField(default=0)),
                ('lineitem_total', models.DecimalField(decimal_places=0, editable=False, max_digits=8)),
