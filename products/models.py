...
class Product(models.Model):
    ...
    weight_alloy = models.DecimalField(max_digits=4, decimal_places=2,
                                 validators=[MinValueValidator(0.01)])
    weight_carbon = models.DecimalField(max_digits=4, decimal_places=2,
                                 validators=[MinValueValidator(0.01)])
    price = models.DecimalField(max_digits=6, decimal_places=2,
                                validators=[MinValueValidator(0.01)])
    price_alloy = models.DecimalField(max_digits=6, decimal_places=2,
                                validators=[MinValueValidator(0.01)])
    price_carbon = models.DecimalField(max_digits=6, decimal_places=2,
                                validators=[MinValueValidator(0.01)])
    price_comment = models.CharField(max_length=120)
    product_image01 = models.ImageField
